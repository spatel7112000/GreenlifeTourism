            ...
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="dashboard.php"><i class="ti-home"></i> Dashboard</a>
                        ...
                        <li class="active"><a href="user.php"><i class="ti-user"></i> User</a></li>
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                               <h1>Hello, <span>Welcome <?php echo $_SESSION['UserID'] ?></span></h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
...
<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $updatequery = "UPDATE tbluser SET UID='$UID',UserID='$UserID',EmailID='$EmailID',MobileNo='$MobileNo',Password='$pass' WHERE UID='$UID' ";       
...
?> 
                                            <div class="form-group">
                                                <h6>UserID</h6>
                                                <input type="text" name="FullName" class="col-sm-6 form-control input-focus" placeholder="Full Name" value="<?php echo $arrdata['UserID']; ?>" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>EmailID</h6>
                                                <input type="email" name="EmailID" class="col-sm-6 form-control input-focus" placeholder="Your Email" value="<?php echo $arrdata['EmailID']; ?>" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>MobileNo</h6>
                                                <input type="text" name="MobileNo" class="col-sm-6 form-control input-focus" placeholder="Your MobileNo" value="<?php echo $arrdata['MobileNo']; ?>" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>Password</h6>
                                                <input type="Password" name="Password" class="col-sm-6 form-control input-focus" placeholder="Your Password" value="<?php echo $arrdata['Password']; ?>" required="">
                                            </div>
