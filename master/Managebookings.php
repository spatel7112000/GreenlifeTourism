              ...
              // include 'include/config.php';  
               ...
               while ($res = mysqli_fetch_array($query)){
                ...
                <tr>
                    ...
                    <td><?php echo $res['CancelledBy']; ?></td>
                    <td><span class="badge badge-primary">
                    <a href="updateuser.php?BID=<?php echo $res['BID']; ?>">Update</a></span>&nbsp;<span class="badge badge-danger">
                        <a href="delete/deletebooking.php?BID=<?php echo $res['BID']; ?>">Remove</a></span>
                </td>
                </tr>
