...
<?php include('include/navbar.php');?>
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Advance Packages</li>
    ...
    <?php
              ...
              // include 'include/config.php';  
               ...
               $selectquery = "select * from Advancepackages";
               ...
               while ($res = mysqli_fetch_array($query)){
                ...
                <tr>
                   ...
                   <td><?php echo $res['Dot']; ?></td>
                   <td><?php echo $res['Detail']; ?></td>
                   <td>                   
                   <span class="badge badge-danger">
                       <a href="delete/deleteadvancepackage.php?ID=<?php echo $res['ID']; ?>">Remove</a></span>
                   </td>
                </tr>
