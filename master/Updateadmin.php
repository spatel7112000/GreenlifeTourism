...
<?php
    ...
    $selectquery = "select * from admin where AdminID=$AdminID";
    ...
    if(isset($_POST['submit'])) {
        ...
        $updatequery = "UPDATE admin SET AdminID='$AdminID',AdminName='$AdminName',EmailID='$EmailID',Password='$pass' WHERE AdminID='$AdminID' ";       
...
?> 
                                            <div class="form-group">
                                                <h6>FullName</h6>
                                                <input type="text" name="FullName" class="col-sm-6 form-control input-focus" placeholder="Full Name" value="<?php echo $arrdata['FullName']; ?>" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>UserName</h6>
                                                <input type="text" name="UserName" class="col-sm-6 form-control input-focus" placeholder="Your UserName" value="<?php echo $arrdata['UserName']; ?>" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>EmailID</h6>
