              ...
              // include 'include/config.php';  
               ...
               while ($res = mysqli_fetch_array($query)){
                ...
                <tr>
                    ...
                    <a href="updateuser.php?UserID=<?php echo $res['UserID']; ?>">Update</a></span>&nbsp;<span class="badge badge-danger">
                        <a href="delete/deleteuser.php?UserID=<?php echo $res['UserID']; ?>">Remove</a></span>
                </td>
                </tr>
