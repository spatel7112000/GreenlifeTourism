                    ...
                    <li><a href="dashboard.php"><i class="ti-home"></i> Dashboard</a>
                         ...
                         <li><a class="sidebar-sub-toggle"><i class="ti-direction-alt"></i>  Tour Packages  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                                ...
                                <li><a href="updatepackage.php">Update</a></li>                            </ul>
                        </li>
                        ...
                        <li class="active"><a class="sidebar-sub-toggle"><i class="ti-direction-alt"></i>  Theme  <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                                    ...
                                    <div class="basic-form">
                                        <form>
                                            <div class="form-group">
                                                <h6>Category Name</h6>
                                                <input type="text" class="col-sm-8 form-control input-focus" placeholder="Create Category" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>Category Type</h6>
                                                <input type="text" class="col-sm-8 form-control input-focus" placeholder="Category Type eg- Family Category / Couple Category" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>Category Location</h6>
                                                <input type="text" class="col-sm-8 form-control input-focus" placeholder="Category Location" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>Category Details</h6>
                                                <textarea id="Subject" class="col-sm-8 form-control input-focus" placeholder="Category Details" style="height:100px" required=""></textarea>
                                            </div>
                                            <div class="form-group">
                                                <h6>Category Price</h6>
                                                <input type="text" class="col-sm-8 form-control input-focus" placeholder="Price" required="">
                                            </div>
                                            <div class="form-group">
                                                <h6>Category Image</h6>
                                                <input type="file" name="Categoryimage" placeholder="Categoryimage" required="">
                                            </div>
                                            <div class="row">
