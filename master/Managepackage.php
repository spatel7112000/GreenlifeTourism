...
<?php include('include/navbar.php');?>
    ...
    <?php
              ...
              // include 'include/config.php';  
               ...
               $selectquery = "select * from tourpackage";
               ...
               while ($res = mysqli_fetch_array($query)){
                ...
                <tr>
                    <td>#PID-<?php echo $res['PID']; ?></td>
                <td><?php echo $res['PName']; ?></td>
                <td><?php echo $res['PType']; ?></td>
                <td><?php echo $res['PLocation']; ?></td>
                <td><?php echo $res['PPrice']; ?></td>
                <td><?php echo $res['PFeatures']; ?></td>
                <td><?php echo $res['CreationDate']; ?></td>
                <td><span class="badge badge-success">
                    <a href="updatepackage.php?PID=<?php echo $res['PID']; ?>">View</a></span>&nbsp;<span class="badge badge-danger">
                        <a href="delete/deletepackage.php?PID=<?php echo $res['PID']; ?>">Delete</a></span>
                </td>
                </tr>
